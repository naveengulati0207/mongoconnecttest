...
from mongoConnectlib import readmongoconnect,writemongoconnect
# import mongoConnectlib.__init__
try:
        Spark = SparkSession \
            .builder \
            .appName("Read Mongo") \
        ...
        read = readmongoconnect("mongo_spark_connect","test4")
        read.show()
        
        SnapCsv = Spark.read.csv('D:/SnapBucketingcsv.csv', header=True, multiLine=True, inferSchema=True)
        SnapCsv.show(50)
        # writemongoconnect("mongo_spark_connect", "test5", SnapCsv)
